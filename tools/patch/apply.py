...
Steps, in order:
  ...
  07  resonite panel a Resonite rail tab; every template's card gets an add-contact button
...
STEPS = [
    ...
    ("07_resonite_panel.py", "a Resonite tab, and add-contact on every template"),
]
